             ...
             <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                <div class="md:flex">
                    ...
                    <div class="md:flex-shrink-0 md:w-1/2 bg-gray-100 relative">
                        ...
                        ${product.flag === 'This week Special' ? `
                        <div class="absolute top-4 left-4 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-lg px-4 py-2 text-sm font-bold shadow-lg uppercase tracking-wide flex items-center gap-2">
