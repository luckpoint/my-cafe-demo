...
app.get('/', async (c) => {
    ...
    return c.html(
        <Layout>
            <Header user={user} cartCount={0} currentPath="/" /> {/* TODO: cartCount from cookie */}
                            ...
                            <div class="sm:text-center lg:text-left">
                                ...
                                <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                                    <div class="rounded-md shadow">
                                        <a href="/products" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-primary hover:bg-opacity-90 md:py-4 md:text-lg md:px-10 transition-colors duration-200">
                                            Order Now
                                        </a>
                                    </div>
                                </div>
            ...
            <div class="bg-gray-50 py-12">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="mt-12 text-center">
                        <a href="/products" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-primary bg-white hover:bg-gray-50 shadow-sm border-gray-200">
                            View All Products
                        </a>
                    </div>
                </div>
